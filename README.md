...
[![License: MIT](https://img.shields.io/badge/License-MIT-21D36A?style=flat-square)](LICENSE)
[![PRs Welcome](https://img.shields.io/badge/PRs-Welcome-FF6900?style=flat-square)](CONTRIBUTING.md)

[![GitHub Stars](https://img.shields.io/github/stars/ruchirhuchgol-del/EAIS?style=social)](https://github.com/ruchirhuchgol-del/EAIS/stargazers)
[![GitHub Forks](https://img.shields.io/github/forks/ruchirhuchgol-del/EAIS?style=social)](https://github.com/ruchirhuchgol-del/EAIS/fork)
[![GitHub Watchers](https://img.shields.io/github/watchers/ruchirhuchgol-del/EAIS?style=social)](https://github.com/ruchirhuchgol-del/EAIS/watchers)
[![GitHub Issues](https://img.shields.io/github/issues/ruchirhuchgol-del/EAIS?style=flat-square)](https://github.com/ruchirhuchgol-del/EAIS/issues)
[![GitHub Discussions](https://img.shields.io/github/discussions/ruchirhuchgol-del/EAIS?style=flat-square)](https://github.com/ruchirhuchgol-del/EAIS/discussions)
...
<img src="https://img.shields.io/badge/⭐_Star_this_repo_if_you_find_it_useful!-FFD700?style=for-the-badge" alt="Star this repo">
...
<p align="center">
  ...
  <a href="https://github.com/ruchirhuchgol-del/EAIS/releases" target="_blank">
    <img src="https://img.shields.io/badge/📥_Download_Video-5865F2?style=for-the-badge&logo=github&logoColor=white" alt="Download Video">
  </a>
</p>
...
|:----------|:-----------|:----------|:------:|
| ✨ **Streamlit UI** | Streamlit, Plotly | Interactive exploration, Executive Dashboards, Rapid Prototyping | ![Recommended](https://img.shields.io/badge/⭐_Recommended-FFD700?style=flat-square) |
| 🌐 **Integration Portal** | Next.js 15, Tailwind, Prisma | Enterprise deployment, User Management, Scalable Web App | ![Stable](https://img.shields.io/badge/Stable-21D36A?style=flat-square) |
| 🔌 **Headless API** | Flask, REST | CI/CD Integration, Custom Frontends, Batch Processing | ![Stable](https://img.shields.io/badge/Stable-21D36A?style=flat-square) |
| 💻 **CLI** | Python, Rich | Scripting, Automation Pipelines, Local Development | ![Beta](https://img.shields.io/badge/Beta-FF6900?style=flat-square) |
...
- ![OpenAI API Key](https://img.shields.io/badge/OpenAI-API_Key-412991?style=flat-square&logo=openai&logoColor=white)
- ![Docker (Optional)](https://img.shields.io/badge/Docker-Optional-2496ED?style=flat-square&logo=docker&logoColor=white)
...
```mermaid
graph TD
    User["👤 User Input<br/>Natural Language Requirements"] --> Orchestrator["🎯 Global Architecture<br/>Orchestrator"]
    
    subgraph AI["🤖 AI Agent Swarm"]
        Orchestrator --> ArchAgent["🏗️ Architecture Agent"]
        Orchestrator --> CompAgent["🛡️ Compliance Agent"]
        Orchestrator --> BizAgent["💼 Business Agent"]
    end
    
    subgraph Core["⚙️ Core Tools & Memory"]
        ArchAgent --> KG["🧠 Knowledge Graph<br/>Engine"]
        CompAgent --> RegDB["📋 Regulatory Framework<br/>Database (50+ standards)"]
        BizAgent --> TCO["💰 TCO/ROI<br/>Calculator"]
    end
    
    subgraph Artifacts["📦 Artifact Generation"]
        ArchAgent & CompAgent & BizAgent --> Gen["⚙️ Generation Engine"]
        Gen --> Terraform["🔲 Terraform Scripts"]
        Gen --> K8s["☸️ Kubernetes Manifests"]
        Gen --> CICD["🔄 CI/CD Pipelines"]
        Gen --> OAS["📖 OpenAPI Specs"]
        Gen --> Diagrams["🖼️ Architecture Diagrams"]
        Gen --> Reports["📄 Compliance Reports"]
    end
    
    Artifacts --> Output["✅ Production-Ready<br/>Output"]
    Output --> User

    style User fill:#4A90D9,color:#fff
    style Orchestrator fill:#FF6B35,color:#fff
    style AI fill:#2ECC71,color:#fff
    style Core fill:#9B59B6,color:#fff
    style Artifacts fill:#E74C3C,color:#fff
...
<a href="https://star-history.com/#ruchirhuchgol-del/EAIS&Date">
 <picture>
   ...
   <img alt="Star History Chart" src="https://api.star-history.com/svg?repos=ruchirhuchgol-del/EAIS&type=Date" />
 </picture>
</a>
...
<img src="https://img.shields.io/badge/⭐_If_you_found_this_useful,_please_give_it_a_star!-FFD700?style=for-the-badge" alt="Star Request">
